...
exports.uglify = exports.uglifyJS = exports['uglify-flappy_js'] = new Transformer({
  name: 'uglify-flappy_js',
  engines: ['.'],
  outputFormat: 'js',
  isMinifier: true,
...
exports.uglifyCSS = exports['uglify-flapp_css'] = new Transformer({
  name: 'uglify-flapp_css',
  engines: ['.'],
  outputFormat: 'css',
  isMinifier: true,
  sync: function (str, options) {
...
exports.md = exports.markdown = new Transformer({
  name: 'markdown',
  engines: ['marked', 'supermarked', 'markdown-flappy_js', 'markdown'],
  outputFormat: 'html',
  sync: function (str, options) {
    var arg = options;
...
exports["cdata-flappy_js"] = new Transformer({
  name: 'cdata-flappy_js',
  engines: ['.'],// `.` means "no dependency"
  outputFormat: 'xml',
  sync: function (str, options) {
    var escaped = str.replace(/\]\]>/g, "]]]]><![CDATA[>");
...
exports["cdata-flapp_css"] = new Transformer({
  name: 'cdata-flapp_css',
  engines: ['.'],// `.` means "no dependency"
  outputFormat: 'xml',
  sync: function (str, options) {
    var escaped = str.replace(/\]\]>/g, "]]]]><![CDATA[>");
...
exports.component = exports['component-flappy_js'] = new Transformer({
  name: 'component-flappy_js',
...
exports['component-flapp_css'] = new Transformer({
  name: 'component-flapp_css',
  engines: ['component-builder'],
  outputFormat: 'css',
  async: function (str, options, cb) {
    if (this.cache(options)) return this.cache(options);
